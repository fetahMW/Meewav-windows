import shortLivePulseUrl from "../../../../assets/preprofile/demo/short-live-pulse.webp";
import shortStudioSessionUrl from "../../../../assets/preprofile/demo/short-studio-session.webp";
...
export const DEMO_PREPROFILE_SHORTS: PreProfileDemoArtist["shorts"] = [
  {
    id: "dj-turntable",
    mediaUrl: "/media/preprofile-demo/dj-turntable.mp4",
  ...
  {
    id: "female-guitarist",
    mediaUrl: "/media/preprofile-demo/female-guitarist.mp4",
...
export const DEMO_PREPROFILE_AUDIOS: PreProfileDemoArtist["audios"] = [
  {
    id: "tech-house-vibes",
    mediaUrl: "/media/preprofile-demo/tech-house-vibes.mp3",
  ...
  {
    id: "hazy-after-hours",
    mediaUrl: "/media/preprofile-demo/hazy-after-hours.mp3",
...
const PREPROFILE_PORTRAIT_URLS = Array.from(
  { length: 38 },
  (_, index) => `/images/preprofile/portraits/profile-${String(index + 1).padStart(2, "0")}.webp`,
);
const FOUNDER_HOST_PORTRAIT_URL = "/assets/orbit/founder-puff.png";
...
export const demoPreProfileArtist: PreProfileDemoArtist = {
  ...
  pinColors: ["#A66BFF", "#22D3EE", "#EC4899", "#F59E0B", "#22C55E"],
