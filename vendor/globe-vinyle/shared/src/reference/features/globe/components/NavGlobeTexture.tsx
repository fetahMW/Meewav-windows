...
export default memo(function NavGlobeTexture({ landColor = "#EFE5FF" }: { landColor?: string }) {
  ...
  useEffect(() => {
    ...
    map.onload = () => {
      ...
      for (let i = 0; i < pixels.data.length; i += 4) {
        ...
        // Opaque land interiors preserve the shared violet instead of mixing
        // with the ocean; fractional alpha remains only in the coastline mask.
